  ...
  <b-form @submit.stop.prevent="formSubmit">
    <b-row>
      <b-col md="6">
        ...
        <b-form-group>
          <b-form-input type="number" v-model="company.phone" required placeholder="Teléfono"></b-form-input>
        </b-form-group>
        ...
        <b-form-group label="Numero de servicios">
                    <b-form-select v-model="company.num_services"  required >
                      <option value="1">1</option>
                      <option value="2">2</option>
                    </b-form-select>
                </b-form-group>

                <b-form-group :label="'Fecha de facturacion: '+ date_custom">
                         <date-picker
                         required
                        v-model="date_custom"
                 ...
                 <b-form-group label="Estado">
                    <b-form-select @change="ActualizarMunicipios" v-model="company.state" :options="city"/>
                </b-form-group>



                <b-form-group label="Municipio">
                    <b-form-select  v-model="company.city" :options="Municipios"/>
                   
                </b-form-group>
        <b-form-group label="Tarifa">
          <b-form-select v-model="company.tariff_type" :options="options" />
        </b-form-group>
        <b-form-group label="Divisiones">
          <b-form-select v-model="company.Division" :options="divisiones" />
        </b-form-group>
        <b-form-group label="Dominio">
          <b-form-input type="string" v-model="company.domain" required placeholder="Dominio" />
        </b-form-group>
        ...
        <b-form-group>
          <b-form-input type="text" v-model="company.address" required placeholder="Dirección"></b-form-input>
        </b-form-group>
      </b-col>
      <b-col md="6">
        <div class="company-user" v-if="availableUser">
          <h5>Nuevo Usuario</h5>
         <b-form-group>
                        <b-form-input
                            type="text"
          ...
          <b-form-select v-model="user.puesto" :options="puestos" />
        </b-form-group>
...
this.company.city = this.Municipios[0].value;
  ...
  data() {
    ...
    this.company.num_services = 1;
     this.company.state = null;
        this.company.city = null
    this.company.tariff_type = "GDMTH";
    this.company.Division = 0;
    this.user.puesto="Gerencia";
    return {
         date_custom: '',
          dateConfig: {
          inline: true,
...
city: [
            { value: null, text: "Escoja un estado " },
                                             ...
                                             { value: "Puebla", text: "Puebla" },
                                               { value: "Querétaro", text: "Querétaro" },
                                                 { value: "Quintana Roo", text: "Quintana Roo" },
                                                   { value: "San Luis Potosí", text: "San Luis Potosi" },
                                                         ...
                                                         { value: "Tabasco", text: "Tabasco" },
                                                           { value: "Tlaxcala", text: "Tlaxcala" },
                                                            { value: "Tamaulipas", text: "Tamaulipas" },
                                                             { value: "Veracruz de Ignacio de la Llave", text: "Verazruz de Ingancio de la Llave" },
                                                              { value: "Yucatán", text: "Yucatan" },
                                                               { value: "Zacatecas", text: "Zacatecas" }
      ],

Municipios: [{value: null, text: "Escoja primero un estado"} ]
,
puestos:  [
